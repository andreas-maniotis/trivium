...
//
//
//  The call map::add_or_replace<  key_value_pair< K, V >  >  yields
...
//
//
//  add_or_replace<> does nothing.
//
//
//  add_or_replace< E1,  R... >
//  performs map::add_or_replace<E1>::add_or_replace<R....> recursively.
//
// -----------------------------------------------------------------------------
...
TEST_CASE("add entries")
{
    ...
    using v_0 = t_0::add_or_replace< entry_4 >;
    using v_1 = t_1::add_or_replace< entry_4 >;
    using v_2 = t_2::add_or_replace< entry_4 >;
    ...
    using x_1 = t_1::add_or_replace<  entry_1_  >;
    using x_2 = t_2::add_or_replace<  entry_1_ >;
    using x_3 = t_3::add_or_replace<  entry_1_ >;
    ...
    using y_2 = t_2::add_or_replace<  entry_2_ >;
    ...
    using z_3 = t_3::add_or_replace<  entry_3_  >;
